...
class _HomePageState extends State<HomePage> {
  List<String> categories = ["Guitarras", "Bajos", "Accesorios", "Amplificadores", "Workshop"];
  List<dynamic> foods = [{
          ...
          children: <Widget>[
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text('Entrega de Instrumentos', style: TextStyle(color: Colors.grey[80], fontWeight: FontWeight.bold, fontSize: 30),),
                  SizedBox(height: 20,),
                  Container(
                    height: 50,
            ...
            Padding(
              ...
              child: Text('Entrega Gratuita', style: TextStyle(color: Colors.grey[700], fontSize: 20, fontWeight: FontWeight.bold),),
            ),
            Expanded(
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: 20.0),
    ...
    return GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: selectedCategory == index ? const Color.fromARGB(255, 211, 67, 199) : Colors.grey[300],
            borderRadius: BorderRadius.circular(50),
          ),
          child: Center(
            child: Text(title, style: TextStyle(
              color: selectedCategory == index ? const Color.fromARGB(255, 255, 255, 255) : Colors.grey[700], 
              fontSize: 16, 
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("\$ 10000.00", style: TextStyle(color: Colors.white, fontSize: 35, fontWeight: FontWeight.bold),),
                      SizedBox(height: 10,),
                      Text("Jackson Kelly", style: TextStyle(color: Colors.white, fontSize: 20),)
                    ],
                  )
                ],
              ),
